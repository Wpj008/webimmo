<?php if(isset($_SESSION['user_id']) && $_SESSION['user_id'] != null):?>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="mainNav">
        <ul class="navbar-nav mx-auto gap-lg-1">
          ...
          <li class="nav-item"><a class="nav-link active" href="properties.html">Acheter</a></li>
  ...
  <?php else:?>
    ...
    <nav class="navbar navbar-expand-lg wi-navbar sticky-top py-3">
    <div class="container">
      <a class="navbar-brand wi-brand d-flex align-items-center gap-2" href="index.html"><span class="brand-badge"><i class="bi bi-buildings"></i></span> Web<span>Immo</span></a>
